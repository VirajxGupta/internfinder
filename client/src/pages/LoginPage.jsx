      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 relative">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button className="flex items-center justify-center gap-2 py-2.5 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-white dark:hover:bg-slate-800 transition-colors text-sm font-medium text-slate-600 dark:text-slate-300 bg-white dark:bg-transparent" onClick={() => toast('DigiLocker Auth coming soon')}>
              <span className="text-blue-600 font-bold text-lg leading-none">D</span>
              DigiLocker
            </button>
          </div>
